...
import { GeoTrackService } from './src/services/geo-track.service.js';
import { RouteService } from './src/services/route.service.js';
import { HeatmapService } from './src/services/heatmap.service.js';
import { createGeoTrackApi } from './src/api/geo-track.api.js';
import { createRouteApi } from './src/api/route.api.js';
import { createWebSocketApi } from './src/api/websocket.api.js';
import { createHeatmapApi } from './src/api/heatmap.api.js';
import { createDriverApi } from './src/api/driver.api.js';
import { DriverService } from './src/services/driver.service.js';
import { RealtimeTrackingService } from './src/services/realtime-tracking.service.js';
...
console.log(`📚 Swagger documentation: http://${app.server?.hostname}:${app.server?.port}/api/swagger`);
